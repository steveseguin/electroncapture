...
window.setFullScreen = value => { assert.equal(value, false); exitRequested = true; };
resizeWindow(window, 1280, 720, scale);
assert.equal(exitRequested, true, 'tracked fullscreen exits even when Electron reports false');
